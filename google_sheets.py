...
class GoogleSheetManager:
    def __init__(self, credentials_file, scopes=None):
        ...
        # Authenticate using the provided service account credentials file
    ...
    def create_sheet(self, title):
        """
        Create a new Google Sheet. If a sheet with the same name exists, return it.
        """
        try:
    ...
    def duplicate_sheet(self, original_sheet_id, new_sheet_name):
        ...
        This method uses the Google Drive API to make a copy of the spreadsheet.
        """
        try:
            ...
            # Use the Drive API to make a copy of the original sheet
            drive_service = build('drive', 'v3', credentials=self.credentials)
